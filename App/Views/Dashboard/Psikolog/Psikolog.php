...
$psikologQuery = $db->prepare("SELECT * FROM psikolog WHERE nama = :username");
$psikologQuery->bindParam(':username', $username);
$psikologQuery->execute();
$info = $psikologQuery->fetch(PDO::FETCH_ASSOC);
...
<head>
    ...
    <title>Contoh</title>
    <link rel="stylesheet" href="Public/Css/Psikolog/Psikolog.css">
        ...
        <div class="header-links">
            ...
            <div class="user-icon" onclick="toggleDropdown()">
                ...
                <div class="dropdown-menu" id="dropdown-menu">
                    ...
                    <p>Saldo : Rp.<?php echo number_format($info['saldo'], 0, ',', '.'); ?></p>
